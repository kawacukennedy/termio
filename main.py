...
stt_online = STTModuleHFAPI(config, security) if STT_HF_AVAILABLE else None
nlp_online = NLPModuleHFAPI(config, security) if NLP_HF_AVAILABLE else None
tts_online = TTSModuleHFAPI(config, security) if TTS_HF_AVAILABLE else None
