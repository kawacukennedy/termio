    ...
    fn default() -> Self {
        Self {
            ...
            memory: MemoryConfig {
                ...
                database_path: PathBuf::from("hedtronix.db"),
                query_timeout_ms: 50,
...
impl Config {
    ...
    pub fn load_from_path(config_dir: Option<PathBuf>) -> Result<Self> {
        ...
        // Add environment variables with HEDTRONIX_ prefix
        let builder = builder.add_source(
            Environment::with_prefix("HEDTRONIX")
                .separator("_")
                .try_parsing(true),
        );
...
mod tests {
    ...
    fn test_default_config() {
        ...
        assert_eq!(config.app.name, "HEDTRONIX");
